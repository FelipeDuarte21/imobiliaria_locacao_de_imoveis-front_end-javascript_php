...
?>
    ...
    <div class="container-fluid">
        ...
        <div id="painel-lista-proprietarios">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="float-right">
                                            <div class="form-inline">
                                                <label for="qtdRegistros" class="mr-2">Exibir:</label>
                                ...
                                <div class="table-responsive-lg">
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody class="text-center" id="list-of-owners"> 
        ...
        <div id="painel-cadastro-proprietario">
        ...
        <div id="painel-informacoes-proprietarios">
            <div class="row justify-content-center mb-3">
    ...
    <script src="js/controller/ProprietarioController.js"></script>
